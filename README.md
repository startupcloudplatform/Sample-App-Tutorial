...
개방형 클라우드 기반의 SW개발 지원 도구의 부족과 창업자(사업자)의 제품 상용화 지원의 필요성으로 창업 플랫폼이 개발되었다. 현재 PaaS-TA에서도 개발을 위한 서비스를 제공하고 있지만 특히 창업자에게 제품 상용화에 필요한 개발 지원 서비스를 제공하여 이전보다 훨씬 빠른 시장 진입에 도움을 주고자 한다.  기존에 비해 풍부한 소프트웨어 개발 지원 서비스를 제공하기 위해 마이크로서비스와 빅데이터, 오픈데이터API 활용을 쉽게하기 위한 도구를 제공한다. 
